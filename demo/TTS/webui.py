    ...
    with gr.Tabs():
        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            with gr.Row():
                ...
                pretrained_s2G = gr.Textbox(label=i18n("预训练的SoVITS-G模型路径"), value="/root/GPT-SoVITS/pretrained_models/s2G488k.pth", interactive=True)
                pretrained_s2D = gr.Textbox(label=i18n("预训练的SoVITS-D模型路径"), value="/root/GPT-SoVITS/pretrained_models/s2D488k.pth", interactive=True)
                pretrained_s1 = gr.Textbox(label=i18n("预训练的GPT模型路径"), value="/root/GPT-SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt", interactive=True)
            with gr.TabItem(i18n("1A-训练集格式化工具")):
                gr.Markdown(value=i18n("输出logs/实验名目录下应有23456开头的文件和文件夹"))
                with gr.Row():
                    inp_text = gr.Textbox(label=i18n("*文本标注文件"),value=r"/root/GPT-SoVITS/hutao.list",interactive=True)
                ...
                with gr.Row():
                    ...
                    bert_pretrained_dir = gr.Textbox(label=i18n("预训练的中文BERT模型路径"),value="/root/GPT-SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",interactive=False)
                ...
                with gr.Row():
                    ...
                    cnhubert_base_dir = gr.Textbox(label=i18n("预训练的SSL模型路径"),value="/root/GPT-SoVITS/pretrained_models/chinese-hubert-base",interactive=False)
